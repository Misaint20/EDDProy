...
namespace EDDemo.Estructuras_lineales
{
    ...
    {
        // Instancia de la clase ListasDoblesCirculares
        CircularesDobles miLista = new CircularesDobles();
        ...
        private void MostrarTodosLosNodos()
        {
            ...
            // Recorre la lista hasta que vuelve a la cabeza
            if (actual != null)
            {
                do
                {
        ...
        // Evento que se ejecuta al hacer clic en el botón para recorrer la lista en reversa
        private void btnRecorrerReversa_Click(object sender, EventArgs e)
        {
            ...
            if (!miLista.EstaVacia())
            {
                Nodo actual = miLista.Cola(); // Obtiene el último nodo de la lista
                ...
                } while (actual != miLista.Cola()); // Para cuando vuelve a la cola
            }
        }
    }
}